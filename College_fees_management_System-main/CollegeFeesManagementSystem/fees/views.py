...
def home(request):
    ...
    # status part start
    k15 = Student.objects.filter(course='K15').count()
    k16 = Student.objects.filter(course='K16').count()
    k17 = Student.objects.filter(course='K17').count()
    k18 = Student.objects.filter(course='K18').count()
    # status part end
    ...
    context = {'students':students, 'k15':k15, 'k16':k16, 'k17':k17, 'k18':k18, 'myfilter':myfilter}
...
def registered_details(request):
    ...
    context = {'all_files':all_files, 'k15':k15, 'k16':k16, 'k17':k17, 'k18':k18,'myfilter':myfilter}
...
def format(request, pk):
    if pk == '1':
        index = [0, 1, 2, 3]
        username = ['20000000', '20000001', '20000002', '20000003']
        firstname = ['Anh', 'Bình', 'Chiến', 'Dương']
        password1 = ['iiitgQ!1', 'iiitgQ!1', 'iiitgQ!1', 'iiitgQ!1']
        middlename = ['','', '','']
        lastname = ['','', '','']
        email = ['anh123@gmail.com', 'binh123@gmail.com', 'chien123@gmail.com', 'duong123@gmail.com']
        phone = ['84000000000', '84000000001','84000000002', '84000000003']
        branch = ['CS', 'DS', 'IT', 'SE']
        course = ['K15','K16','K17', 'K18']
